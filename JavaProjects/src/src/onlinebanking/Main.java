...
import src.onlinebanking.Account;
import src.onlinebanking.Bank;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (userInput) {
                case 1:
                    bank.checkBalance(userAccount.getAccNum());
                    break;
                case 2:
                    System.out.println("Enter amount to Deposit");
                    double depositAmount = sc.nextDouble();
                    bank.deposit(depositAmount, userAccount.getAccNum());
                    break;
                case 3:
                    System.out.println("Enter amount to withdraw");
                    double withdrawAmount = sc.nextDouble();
                    bank.withdraw(withdrawAmount, userAccount.getAccNum());
                    break;
                    
                case 4:
                	System.out.println("Enter receipents account number");
                	int receiptantAccNm = sc.nextInt();
                	System.out.println("Enter amount to transfer");
                    double transferAmount = sc.nextDouble(); 
                		bank.transferAmount(transferAmount, receiptantAccNm, userAccount.getAccNum());
                	break;
                case 5:
                    sc.close();
